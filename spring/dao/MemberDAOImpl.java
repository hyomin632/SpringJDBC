...
public class MemberDAOImpl implements MemberDAO {
	...
	public void insertMember(Member m) {
		...
		if (cnt > 0) System.out.println("회원 데이터 추가 완료!");
	}

	@Override
	public List<Member> selectAllMember() {
		String sql = " select mno, userid, name, joindate from member order by mno ";
	...
	protected class MemberMapper implements RowMapper<Member> {
		...
		public Member mapRow(ResultSet rs, int num) throws SQLException {
			...
			Member m = new Member(mno, userid, null, name, null, joindate);
	...
	protected class MemberOneMapper implements RowMapper<Member> {
		...
		public Member mapRow(ResultSet rs, int num) throws SQLException {
			...
			Member m = new Member(mno, userid, null, name, email, joindate);
	...
	public void updateMember(Member m) {
		...
		if (cnt > 0) System.out.println("회원 정보 수정 완료!");
	}
	...
	public void deleteMember(int mno) {
		...
		int cnt = jdbcTemplate.update(sql, params);
		if (cnt > 0) System.out.println("회원 정보 삭제 완료!");
	}
